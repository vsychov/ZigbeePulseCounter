...
#define APP_MODEL_IDENTIFIER "ESP32C6-PulseMeter-Electric"
#elif CONFIG_ZB_VARIANT_WATER
#define APP_UNIT_OF_MEASURE 1
#define APP_METERING_DEVICE_TYPE 2
#define APP_MODEL_IDENTIFIER "ESP32C6-PulseMeter-Water"
#else
#define APP_UNIT_OF_MEASURE 1
#define APP_METERING_DEVICE_TYPE 1
#define APP_MODEL_IDENTIFIER "ESP32C6-PulseMeter-Gas"
#endif
