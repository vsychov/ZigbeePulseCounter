...
#warning "CONFIG_PULSE_GPIO must be an RTC-capable GPIO (GPIO7-14 on ESP32H2)"
#endif
#if CONFIG_FACTORY_RESET_BUTTON_GPIO >= 0 && (CONFIG_FACTORY_RESET_BUTTON_GPIO < 7 || CONFIG_FACTORY_RESET_BUTTON_GPIO > 14)
#warning "CONFIG_FACTORY_RESET_BUTTON_GPIO must be RTC-capable (GPIO7-14)"
#endif
#elif CONFIG_IDF_TARGET_ESP32C6
#if CONFIG_PULSE_GPIO < 0 || CONFIG_PULSE_GPIO > 7
#warning "CONFIG_PULSE_GPIO must be an RTC-capable GPIO (GPIO0-7 on ESP32C6)"
#endif
#if CONFIG_FACTORY_RESET_BUTTON_GPIO >= 0 && (CONFIG_FACTORY_RESET_BUTTON_GPIO < 0 || CONFIG_FACTORY_RESET_BUTTON_GPIO > 7)
#warning "CONFIG_FACTORY_RESET_BUTTON_GPIO must be RTC-capable (GPIO0-7)"
#endif
#endif
